...
new const WEAPON_V_MDL[] = "models/gunxpmod/v_aug.mdl";
#define WEAPON_CSW CSW_AUG
new const weapon_n[] = "weapon_aug";
...
public plugin_init() 
{
	...
	register_gxm_item("AUG A3", "+Aim +Rate +Power ( AUG )", 75)

	damage_weapon = register_cvar("gxm_damage_ak","1.5"); // dmg +
	pCvarRof = register_cvar( "ak_rof", "0.090" ); // szybkosc strzalu +
	weapon_recoil = register_cvar( "aug_recoil", "0.5" ); // recoil
