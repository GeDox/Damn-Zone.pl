...
new PLUGIN_NAME[] 	= "Fiveseven"
new PLUGIN_AUTHOR[] 	= "xbatista"
new PLUGIN_VERSION[] 	= "1.0"

new const WEAPON_V_MDL[] = "models/gunxpmod/v_fiveseven.mdl";
#define WEAPON_CSW CSW_FIVESEVEN
new const weapon_n[] = "weapon_fiveseven";
...
public plugin_init() 
{
	...
	register_gxm_item("1911A1 (Fiveseven)", "+Aim -Rate +Power ( Fiveseven )", 15)
	
	damage_weapon = register_cvar("gxm_damage_dg","2.0"); // damage multiplier
	weapon_recoil = register_cvar( "fs_recoil", "0.8" ); // weapon recoil
