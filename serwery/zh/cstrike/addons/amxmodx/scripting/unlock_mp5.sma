...
new const WEAPON_V_MDL[] = "models/gunxpmod/v_mp5.mdl";
#define WEAPON_CSW CSW_MP5NAVY
new const weapon_n[] = "weapon_mp5navy";
...
public plugin_init() 
{
	...
	register_gxm_item("PP-41 (MP5)", "+Aim +Rate +Power +Scope ( MP5NAVY )", 40)

	damage_weapon = register_cvar("gxm_damage_mp5navy","2.0"); // wiekszy dmg
	pCvarRof = register_cvar( "ak_rof", "0.090" ); // weapon rof
	weapon_recoil = register_cvar( "mp5_recoil", "0.3" ); // rozrzut +mniejszy -wiêkszy
