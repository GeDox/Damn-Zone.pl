...
public plugin_init() 
{
	...
	register_gxm_item("Sawn Off Shotgun", "-Clip -Aim -Rate +Power +Scope ( Xm1014 )", 80)

	damage_weapon = register_cvar("gxm_damage_xm","2.5"); // damage multiplier
	pCvarRof = register_cvar( "xm_rof", "0.2" ); // weapon rof
	weapon_recoil = register_cvar( "xm_recoil", "1.5" ); // weapon recoil
